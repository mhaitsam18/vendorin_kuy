        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php if ($title=="Chart"): echo "active"; endif ?>">
                <a class="nav-link" href="<?= base_url()?>vendor/chart">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Chart</span> 
            ...
            <!-- <li class="nav-item <?php if ($title=="Profil Vendor"): echo "active"; endif ?>">
                <a class="nav-link" href="<?php echo base_url('vendor/profil_vendor') ?>">
                    <i class="fas fa-fw fa-file-invoice"></i>
                    <span>Profil</span>
                </a>
            </li> -->
